...
class Template:
    ...
    def encode_oneturn(
        ...
        tools: Optional[str] = None) -> tuple[list[int], list[int]]:
    ...
    def _encode(
        ...
        messages: list[dict[str, str]],
        system: Optional[str],
        tools: Optional[str]) -> list[list[int]]:
...
class ReasoningTemplate(Template):
    ...
    def encode_multiturn(
        ...
        system: Optional[str] = None,
        tools: Optional[str] = None,
        discarding_history_cot: bool = False) -> list[tuple[list[int], list[int]]]:
        messages = deepcopy(messages)
        if self.enable_thinking is False:  # remove all cot
...
def register_template(
    ...
    template_class: type["Template"] = Template) -> None:
