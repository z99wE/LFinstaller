...
def _load_single_dataset(
    ...
    training_args: "Seq2SeqTrainingArguments") -> Union["Dataset", "IterableDataset"]:
...
def _get_merged_dataset(
    ...
    return_dict: bool = False) -> Union["Dataset", "IterableDataset", dict[str, "Dataset"]] | None:
...
def _get_dataset_processor(
    ...
    do_generate: bool = False) -> "DatasetProcessor":
...
def _get_preprocessed_dataset(
    ...
    is_eval: bool = False) -> Union["Dataset", "IterableDataset"] | None:
...
def get_dataset(
    ...
    stage: Literal["pt", "sft", "rm", "ppo", "kto"],
    tokenizer: "PreTrainedTokenizer",
    processor: Optional["ProcessorMixin"] = None) -> "DatasetModule":
