...
class HuggingfaceEngine(BaseEngine):
    ...
    def _process_args(
        ...
        input_kwargs: Optional[dict[str, Any]] = {}) -> tuple[dict[str, Any], int]:
    ...
    def _chat(
        ...
        videos: Optional[list["VideoInput"]] = None,
        audios: Optional[list["AudioInput"]] = None,
        input_kwargs: Optional[dict[str, Any]] = {}) -> list["Response"]:
    ...
    def _stream_chat(
        ...
        videos: Optional[list["VideoInput"]] = None,
        audios: Optional[list["AudioInput"]] = None,
        input_kwargs: Optional[dict[str, Any]] = {}) -> Callable[[], str]:
    ...
    def _get_scores(
        ...
        input_kwargs: Optional[dict[str, Any]] = {}) -> list[float]:
        max_length: Optional[int] = input_kwargs.pop("max_length", None)
