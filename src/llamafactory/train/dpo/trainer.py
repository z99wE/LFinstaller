...
class CustomDPOTrainer(DPOTrainer):
    ...
    def compute_preference_loss(
        ...
        reference_rejected_logps: Optional["torch.Tensor"]) -> tuple["torch.Tensor", "torch.Tensor", "torch.Tensor"]:
    ...
    def get_batch_loss_metrics(
        ...
        train_eval: Literal["train", "eval"] = "train") -> tuple["torch.Tensor", dict[str, "torch.Tensor"]]:
