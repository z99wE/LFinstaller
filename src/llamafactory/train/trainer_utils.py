...
def _create_galore_optimizer(
    ...
    training_args: "TrainingArguments",
    finetuning_args: "FinetuningArguments") -> "torch.optim.Optimizer":
...
def _create_adam_mini_optimizer(
    model: "PreTrainedModel",
    training_args: "TrainingArguments") -> "torch.optim.Optimizer":
...
def create_custom_optimizer(
    model: "PreTrainedModel",
    training_args: "TrainingArguments",
    finetuning_args: "FinetuningArguments") -> Optional["torch.optim.Optimizer"]:
...
def get_batch_logps(
    ...
    ld_alpha: Optional[float] = None) -> tuple["torch.Tensor", "torch.Tensor"]:
