...
class CustomPPOTrainer(PPOTrainer, Trainer):
    ...
    def get_rewards(
        ...
        responses: list["torch.Tensor"]) -> list["torch.Tensor"]:
    ...
    def batched_forward_pass(
        ...
        response_masks: Optional["torch.Tensor"] = None) -> tuple["torch.Tensor", Optional["torch.Tensor"], "torch.Tensor", "torch.Tensor"]:
