...
def create_train_tab(engine: "Engine") -> dict[str, "Component"]:
    ...
    arg_save_btn.click(engine.runner.save_args, input_elems, output_elems)
    arg_load_btn.click(
        engine.runner.load_args, [lang, config_path], list(input_elems) + [output_box])
    ...
    output_dir.change(
        list_output_dirs, [model_name, finetuning_type, current_time], [output_dir])
    output_dir.input(
