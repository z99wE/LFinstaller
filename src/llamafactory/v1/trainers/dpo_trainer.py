...
class DPOTrainer(BaseTrainer):
    ...
    def _extract_chosen_rejected_logps(
        ...
        use_ld: bool = True) -> tuple[Tensor, Tensor, Tensor, Tensor]:
        ...
        per_token_logps = -F.cross_entropy(
            ...
            shift_labels.view(-1),
            reduction="none",
            ignore_index=IGNORE_INDEX).view(shift_labels.size(0), shift_labels.size(1))
    ...
    def _sigmoid_dpo_loss(
        ...
        policy_rejected_logps: Tensor,
        ref_chosen_logps: Tensor,
        ref_rejected_logps: Tensor) -> Tensor:
